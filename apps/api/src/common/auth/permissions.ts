...
export const PERMISSIONS = {
  ...
  doctors_archive: "doctors.archive",
  doctors_restore: "doctors.restore",
  doctors_manage_schedule: "doctors.manageSchedule",
  doctors_manage_account: "doctors.manageAccount",
  doctors_reset_password: "doctors.resetPassword",
  secretaries_read: "secretaries.read",
  secretaries_create: "secretaries.create",
  secretaries_update: "secretaries.update",
  secretaries_archive: "secretaries.archive",
  secretaries_reset_password: "secretaries.resetPassword",
  ...
  contact_channels_manage: "contact_channels.manage",
} as const;
...
export const DOCTOR_SPECIALIST_PERMISSIONS: PermissionKey[] = [
  ...
  PERMISSIONS.doctors_archive,
  PERMISSIONS.doctors_restore,
  PERMISSIONS.doctors_manage_schedule,
  PERMISSIONS.doctors_manage_account,
  PERMISSIONS.doctors_reset_password,
  PERMISSIONS.manage_secretaries,
  PERMISSIONS.secretaries_read,
  PERMISSIONS.secretaries_create,
  PERMISSIONS.secretaries_update,
  PERMISSIONS.secretaries_archive,
  PERMISSIONS.secretaries_reset_password,
  ...
  PERMISSIONS.contact_channels_manage,
