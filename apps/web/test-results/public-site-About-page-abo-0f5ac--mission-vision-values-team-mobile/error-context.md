...
- Name: public-site.spec.ts >> About page >> about includes mission vision values team
- Location: e2e/public-site.spec.ts:187:7
...
Locator: getByRole('heading', { name: /رسالتنا|رؤيتنا/ }).first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('heading', { name: /رسالتنا|رؤيتنا/ }).first()
