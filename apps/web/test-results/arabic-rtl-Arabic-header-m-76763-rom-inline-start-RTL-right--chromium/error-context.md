...
- Name: arabic-rtl.spec.ts >> Arabic header + mobile menu >> mobile menu opens from inline-start (RTL right)
- Location: e2e/arabic-rtl.spec.ts:88:7
...
Call log:
  - waiting for getByRole('button', { name: 'القائمة' })
