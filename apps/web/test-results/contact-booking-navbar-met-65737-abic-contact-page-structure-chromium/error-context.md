...
- Name: contact-booking-navbar-metadata.spec.ts >> Contact page + navbar + titles >> Arabic contact page structure
- Location: e2e/contact-booking-navbar-metadata.spec.ts:4:7
...
Locator: getByRole('heading', { name: /تواصل معنا واحجز موعدك/, level: 1 })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('heading', { name: /تواصل معنا واحجز موعدك/, level: 1 })
