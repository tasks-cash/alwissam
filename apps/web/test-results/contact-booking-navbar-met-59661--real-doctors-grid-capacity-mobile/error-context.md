...
- Name: contact-booking-navbar-metadata.spec.ts >> Contact page + navbar + titles >> booking section shows wizard with real doctors grid capacity
- Location: e2e/contact-booking-navbar-metadata.spec.ts:57:7
...
Locator: locator('.appointment-wizard')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('.appointment-wizard')
