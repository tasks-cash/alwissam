...
- Name: public-site.spec.ts >> Homepage premium sections >> contact and Facebook links are functional
- Location: e2e/public-site.spec.ts:153:7
...
Locator: locator('a[href="tel:+213663098208"]').first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('a[href="tel:+213663098208"]').first()
