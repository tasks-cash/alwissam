...
- Name: contact-booking-navbar-metadata.spec.ts >> Contact page + navbar + titles >> locale routes still work without navbar switcher
- Location: e2e/contact-booking-navbar-metadata.spec.ts:89:7
