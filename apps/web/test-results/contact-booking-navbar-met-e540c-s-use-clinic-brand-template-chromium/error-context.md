...
- Name: contact-booking-navbar-metadata.spec.ts >> Contact page + navbar + titles >> browser titles use clinic brand template
- Location: e2e/contact-booking-navbar-metadata.spec.ts:102:7
...
Expected pattern: /عيادة الوسام لطب الأسنان \| الرئيسية/
Received string:  ""
Timeout: 5000ms
