...
- Name: public-site.spec.ts >> Homepage premium sections >> Arabic home shows why, journey, hours, and max 3 doctors
- Location: e2e/public-site.spec.ts:51:7
...
Locator: getByRole('heading', { name: /لماذا عيادتنا/ })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('heading', { name: /لماذا عيادتنا/ })
