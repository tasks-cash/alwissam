...
- Name: contact-booking-navbar-metadata.spec.ts >> Contact page + navbar + titles >> phone accepts digits only
- Location: e2e/contact-booking-navbar-metadata.spec.ts:50:7
