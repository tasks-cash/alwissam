...
- Name: contact-booking-navbar-metadata.spec.ts >> Contact page + navbar + titles >> language switcher absent from public navbar and mobile menu
- Location: e2e/contact-booking-navbar-metadata.spec.ts:76:7
...
Call log:
  - waiting for getByRole('button', { name: /القائمة|Menu/i })
