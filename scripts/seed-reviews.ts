...
async function main() {
  ...
  for (const [i, t] of DRAFT_TEMPLATES.entries()) {
    ...
    const approved = publishFixtures;
    await reviews.insertOne({
      displayName: "مريض من عيادة الوسام",
      displayNameAr: "مريض من عيادة الوسام",
      displayNameEn: "Al-Wisam clinic patient",
      displayNameFr: "Patient de la clinique Al-Wisam",
      isAnonymous: true,
      quoteAr: t.quoteAr,
      quoteEn: t.quoteEn,
      quoteFr: t.quoteFr,
